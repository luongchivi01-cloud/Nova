...
- [x] GitHub contains reproduction instructions and method document.
- [ ] Team registration and links submitted at http://hackaithon.vsds.vn.

The public test is used only as a smoke test for runtime and CSV format. The submission contains no fixed public-answer assertion or answer sequence.